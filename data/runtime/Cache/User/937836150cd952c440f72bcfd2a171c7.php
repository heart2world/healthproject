		...
		<section class="contentSec nameSec">
			<div class="weui-cells weui-cells_checkbox">
	            ...
	            <label class="weui-cell weui-check__label" for="s12">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s12" value="降压降糖药" <?php if($index1 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s13">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s13" value="缓解哮喘药物" <?php if($index2 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s14">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s14" value="解热镇痛药物" <?php if($index3 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s15">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s15" value="激素类药物" <?php if($index4 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s16">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s16" value="抗抑郁药物" <?php if($index5 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <div class="weui-cell">
	                <div class="weui-cell__hd">
	                	<label class="weui-label">药品名称</label>
	                </div>
	                <div class="weui-cell__bd">
	                    <input class="weui-input right" type="text" placeholder="请输入" id="drugname" value="<?php echo ($drugname); ?>">
	                </div>
	            </div>
	            <div class="weui-cell">
	                <div class="weui-cell__hd">
	                	<label class="weui-label">服务剂量</label>
	                </div>
	                <div class="weui-cell__bd">
	                    <input class="weui-input right" type="text" placeholder="请输入" id="drugpoint" value="<?php echo ($drugpoint); ?>">
	                </div>
	            </div>
	            <div class="weui-cell">
	                <div class="weui-cell__hd">
	                ...
	                <div class="weui-cell__bd">
	                    <input class="weui-input right other" type="text" placeholder="请注明" value="<?php echo ($drugelse); ?>">
	                </div>
	            </div>
	        </div>
...
$(function(){
	...
	$('.save').click(function(){
		...
		var drugpoint =$("#drugpoint").val();
		var drugelse =$(".other").val();
		$.ajax({
			url:"<?php echo U('User/Profile/edityyspost');?>",
			data:{historydurg:myhealth,drugname:drugname,drugpoint:drugpoint,drugelse:drugelse},
			type:'POST',
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data.status==0)
				{
  						...
  						location.href="<?php echo U('User/Profile/editgms');?>";  									
