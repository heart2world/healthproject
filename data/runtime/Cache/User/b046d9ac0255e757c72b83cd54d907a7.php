			...
			<div class="weui-cells weui-cells_checkbox">
	            <label class="weui-cell weui-check__label" for="s11">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s11" value="每天能按时三餐" <?php if($index1 == 1): ?>checked<?php endif; ?>>
	            ...
	            <label class="weui-cell weui-check__label" for="s12">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox2" id="s12" value="喜欢暴饮暴食" <?php if($index2 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s13">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox3" id="s13" value="喜欢喝饮料" <?php if($index3 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s14">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox4" id="s14" value="喜欢油炸、腌制、烧烤、生冷等刺激性食物" <?php if($index4 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s15">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox5" id="s15" value="经常吃甜食" <?php if($index5 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s16">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox5" id="s16" value="最近经常吃海鲜" <?php if($index6 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s17">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox5" id="s17" value="不爱吃素菜、水果" <?php if($index7 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <div class="weui-cell">
	                ...
	                <div class="weui-cell__bd">
	                    <input class="weui-input right other" type="text" placeholder="请注明" value="<?php echo ($foodelse); ?>">
	                </div>
	            </div>
	        </div>
...
<script>
	$('.save').click(function(){
		...
		$.ajax({
			url:"<?php echo U('User/Profile/editysxgpost');?>",
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data.status==0)
				{
  						...
  						location.href="<?php echo U('User/Profile/editxlzk');?>";  									
