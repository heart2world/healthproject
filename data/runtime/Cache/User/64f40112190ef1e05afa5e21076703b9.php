		...
		<section class="contentSec nameSec">
			<div class="weui-cells weui-cells_checkbox">
	            ...
	            <label class="weui-cell weui-check__label" for="s14">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s14" value="肿瘤" <?php if($index3 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <label class="weui-cell weui-check__label" for="s15">
	                ...
	                <div class="weui-cell__hd">
	                    <input type="checkbox" class="weui-check" name="checkbox1" id="s15" value="地中海贫血" <?php if($index4 == 1): ?>checked<?php endif; ?>>
	                    <i class="weui-icon-checked"></i>
	                </div>
	            </label>
	            <div class="weui-cell">
	                ...
	                <div class="weui-cell__bd">
	                    <input class="weui-input right other" type="text" placeholder="请注明" value="<?php echo ($hillnesselse); ?>">
	                </div>
	            </div>
	        </div>
...
$(function(){
	...
	$('.save').click(function(){
		...
		$.ajax({
			url:"<?php echo U('User/Profile/editjzbspost');?>",
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data.status==0)
				{
  						...
  						location.href="<?php echo U('User/Profile/editsss');?>";  									
