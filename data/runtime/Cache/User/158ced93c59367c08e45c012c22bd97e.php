			...
			<div class="weui-cells weui-cells_form">
	            <div class="weui-cell weui-cell_default">
	                <div class="weui-cell__bd">
	                    <input class="weui-input inputBox name" type="text" placeholder="请输入姓名" value="<?php echo ($nicename); ?>">
	                </div>
...
$(function(){
	...
	$('.save').click(function(){
		...
		$.ajax({
			url:"<?php echo U('User/Profile/editnamepost');?>",
			data:{nicename:$('.name').val()},
			type:'POST',
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data.status==0)
				{
  						...
  						location.href="<?php echo U('User/profile/editsex');?>";  									
