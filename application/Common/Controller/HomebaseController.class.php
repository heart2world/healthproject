...
class HomebaseController extends AppframeController {
	...
	protected function  check_user(){
	    $user_status=M('Member')->where(array("id"=>sp_get_current_userid()))->getField("status");
		 header('content-type:text/html;charset=utf-8');
		if($user_status==0){
			echo '<center style="font-size:40px;padding:10px;width:100%;overflow:hidden;">您的账户被冻结，请联系管理员！</center>';
			exit;
		}
	}
